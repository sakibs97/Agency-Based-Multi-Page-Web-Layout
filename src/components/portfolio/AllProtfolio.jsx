...
import growth1 from "../../assets/team-member/profolio/growth1.jpg";
            ...
            <div className="container">
                ...
                <div className="text-center mt-8">
                    <button
                        ...
                        className="py-[15px] px-[33px] bg-gradient-to-r from-startC to-endC rounded-full font-dmSans font-normal text-[18px] text-white leading-[30px]">{show ? 'Show Less' : 'View More Projects'}</button>
                </div>
            </div>
        </section>
    )
