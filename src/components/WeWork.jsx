import icon from '../assets/Services/work/logo/icon.png'
import icon2 from '../assets/Services/work/logo/icon2.png'
import icon3 from '../assets/Services/work/logo/icon3.png'

const WeWork = () => {
    return (
        <section className='bg-[#F4F4FF] bg-cover bg-no-repeat bg-center relative z-20'>
            <div className='after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-[url("/src/assets/Services/work/banner.png")] after:bg-cover after:bg-no-repeat after:bg-center z-0'></div>
            <div className="container py-28 relative z-20">
                ...
                <div className="flex justify-between gap-5 mt-[50px]">
                    <div className='bg-[url("/src/assets/Services/work/workban.png")] bg-center bg-no-repeat w-full rounded-3xl relative group cursor-pointer'>
                        <div className="bg-[#3661FC] w-[150px] h-[150px] rounded-full absolute left-[5%] -z-10 group-hover:bg-gradient-to-r from-startC to-endC group-hover:bg-transparent">
                        </div>
                        <div className="absolute left-[10%] top-[10%] w-[100px] rounded-full bg-gradient-to-r from-startC to-endC bg-transparent group-hover:bg-gradient-to-t group-hover:from-[#3661FC] group-hover:to-[#3661fcda]">
                            <div className="py-[30px]">
                                <img src={icon} alt="" className='mx-auto' />
                            </div>
                        </div>
                        <div className="px-[25px] py-[40px] flex justify-between z-30">
                            <div className="relative">
                                <h5 className='font-nuni font-bold text-[46px] text-main leading-[56px] opacity-20 absolute bottom-0 translate-y-1/2'>01</h5>
                            </div>
                            <div className="z-30">
                                <h4 className='font-nuni font-bold text-[25px] text-main'>Business Planning</h4>
                                <p className='font-dmSans font-normal text-[16px] text-main w-[250px]'>There are many variations of pass Lorem Ipsum available, but the a have suffered alteration.</p>
                            </div>
                        </div>
                    </div>
                    <div className='bg-[url("/src/assets/Services/work/workban.png")] bg-center bg-no-repeat w-full rounded-3xl relative group cursor-pointer'>
                        ...
                        <div className="absolute left-[10%] top-[10%] w-[100px] rounded-full bg-gradient-to-r from-startC to-endC bg-transparent group-hover:bg-gradient-to-r group-hover:from-[#3661FC] group-hover:to-[#3661fc]">
                            <div className="py-[30px]">
                        ...
                        <div className="px-[25px] py-[40px] flex justify-between z-30">
                            <div className="relative">
                                <h5 className='font-nuni font-bold text-[46px] text-main leading-[56px] opacity-20 absolute bottom-0 translate-y-1/2'>02</h5>
                            </div>
                            <div className="z-30">
                                <h4 className='font-nuni font-bold text-[25px] text-main'>Business Planning</h4>
                                <p className='font-dmSans font-normal text-[16px] text-main w-[250px]'>There are many variations of pass Lorem Ipsum available, but the a have suffered alteration.</p>
                    ...
                    <div className='bg-[url("/src/assets/Services/work/workban.png")] bg-center bg-no-repeat w-full rounded-3xl relative group cursor-pointer'>
                        ...
                        <div className="px-[25px] py-[40px] flex justify-between z-30">
                            <div className="relative">
                                <h5 className='font-nuni font-bold text-[46px] text-main leading-[56px] opacity-20 absolute bottom-0 translate-y-1/2'>03</h5>
                            </div>
                            <div className="z-30">
                                <h4 className='font-nuni font-bold text-[25px] text-main'>Business Planning</h4>
                                <p className='font-dmSans font-normal text-[16px] text-main w-[250px]'>There are many variations of pass Lorem Ipsum available, but the a have suffered alteration.</p>
