...
const ServiceProjects = () => {
    return (
        <section className='bg-[url("/src/assets/Services/work/support/banner.jpg")] bg-cover bg-no-repeat bg-center py-28 relative after:absolute after:left-0 after:top-0 after:w-full after:h-full after:bg-[url("/src/assets/Services/work/support/after.png")] after:bg-cover after:bg-center after:bg-no-repeat'>
