...
const Navbar = () => {
    return (
        // fixed w-full lg:px-[10px] z-20 top-0 start-0
        <section className="bg-[#CCCCCC]">
                ...
                <div className="w-[60%] flex items-center justify-between">
                    <div className="flex items-center group">
                        ...
                        <div className="mx-3">
                            ...
                            <h5 className="font-dmSans font-normal text-[18px] text-[#1A1A1A] leading-[24px]">+88 ( 5548 ) 6548</h5>
                        </div>
                    </div>
                    <div className="flex items-center group">
                        <div className="">
                        ...
                        <div className="mx-3">
                            ...
                            <h5 className="font-dmSans font-normal text-[18px] text-[#1A1A1A] leading-[24px]">infoyour@gmail.com</h5>
                        </div>
                    </div>
                    <div className="flex items-center group">
                        <div className="">
            ...
            <div className="container">
                <nav className=" flex justify-between border bg-white px-5 rounded-full">
                    <ul className="font-pop font-normal text-[16px] text-[#1A1A1A] leading-[90px] flex items-center">
