        ...
        <section className='relative bg-[url("/src/assets/banner/watermark.png")] bg-cover bg-no-repeat bg-center py-28 pt-96 after:bg-[#F4F4FF] after:w-full after:h-full after:absolute after:top-0 after:left-0 after:-z-10'>
            <div className='container flex justify-between items-center relative'>
                <div className="">
                    ...
                    <GiCrossMark className="absolute bg-gradient-to-r from-startC to-endC right-[50%] bottom-0 text-white" />
                    <BsTriangleFill className="absolute right-0 -top-12 -rotate-45" />
                    <FaCircle className="absolute left-[50%] top-[20%] text-startC" />
                </div>
                <div className="">
                    ...
                    <div className="flex items-center py-10">
                        <button className="font-sans font-normal text-[18px] text-white py-[15px] px-[33px] bg-gradient-to-r from-startC to-endC rounded-full">
                            Discover More
                        </button>
                        <button className="font-sans font-normal text-[18px] hover:text-white py-[15px] px-[33px] hover:bg-gradient-to-r hover:from-startC hover:to-endC rounded-full ml-5 bg-white duration-500">
                            Discover More
                        </button>
                    </div>
                </div>
