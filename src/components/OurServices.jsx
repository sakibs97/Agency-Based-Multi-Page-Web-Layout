        ...
        <section className='bg-[#F4F4FF] py-20'>
            <div className="container">
                ...
                <div className="group">
                    <div className="p-[2px] group-hover:bg-gradient-to-r from-startC to-endC my-5 rounded-3xl">
                        <div className="flex justify-between items-center p-5 bg-white rounded-3xl">
                            <img src={seo} alt="seo" className='rounded-3xl' />
                            <div className="w-[700px]">
                                <h4 className='font-nuni font-bold text-[25px] text-main pb-5'>Search Engine Optimization</h4>
                                <p className='font-dmSans font-normal text-[16px] text-ptag'>
                                    There are many variations of passages of Lorem Ipsum available, but the majority our as have suffered alteration in some form, by injected humour, or randomized word which don&apos;t worry a look even slight believable. If you are going to use a passage.
                                </p>
                            </div>
                ...
                <div className="group">
                    <div className="p-[2px] group-hover:bg-gradient-to-r from-startC to-endC my-5 rounded-3xl">
                        <div className="flex justify-between items-center p-5 bg-white rounded-3xl">
                            <img src={web} alt="web" className='rounded-3xl' />
                            <div className="w-[700px]">
                                <h4 className='font-nuni font-bold text-[25px] text-main pb-5'>Web Design & Development</h4>
                                <p className='font-dmSans font-normal text-[16px] text-ptag'>
                                    There are many variations of passages of Lorem Ipsum available, but the majority our as have suffered alteration in some form, by injected humour, or randomized word which don&apos;t worry a look even slight believable. If you are going to use a passage.
                                </p>
                            </div>
                ...
                <div className="group">
                    <div className="p-[2px] group-hover:bg-gradient-to-r from-startC to-endC my-5 rounded-3xl">
                        <div className="flex justify-between items-center p-5 bg-white rounded-3xl">
                            <img src={email} alt="email" className='rounded-3xl' />
                            <div className="w-[700px]">
                                <h4 className='font-nuni font-bold text-[25px] text-main pb-5'>Email and Content Marketing</h4>
                                <p className='font-dmSans font-normal text-[16px] text-ptag'>
                                    There are many variations of passages of Lorem Ipsum available, but the majority our as have suffered alteration in some form, by injected humour, or randomized word which don&apos;t worry a look even slight believable. If you are going to use a passage.
                                </p>
                            </div>
                ...
                <div className="group">
                    <div className="p-[2px] group-hover:bg-gradient-to-r from-startC to-endC my-5 rounded-3xl">
                        <div className="flex justify-between items-center p-5 bg-white rounded-3xl">
                            <img src={social} alt="social" className='rounded-3xl' />
                            <div className="w-[700px]">
                                <h4 className='font-nuni font-bold text-[25px] text-main pb-5'>Social Media Network Marketing </h4>
                                <p className='font-dmSans font-normal text-[16px] text-ptag'>
                                    There are many variations of passages of Lorem Ipsum available, but the majority our as have suffered alteration in some form, by injected humour, or randomized word which don&apos;t worry a look even slight believable. If you are going to use a passage.
                                </p>
                            </div>
