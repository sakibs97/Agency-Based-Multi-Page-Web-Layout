            ...
            <div className="container">
                ...
                <div className="">
                    {ServiceData.map((item) => (
                        <>
                            <div className="p-[2px] hover:bg-gradient-to-r from-startC to-endC my-5 rounded-3xl">
                                <div key={item.id} className="flex justify-between items-center p-5 bg-white rounded-3xl">
